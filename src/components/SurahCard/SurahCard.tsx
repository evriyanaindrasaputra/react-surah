  ...
  return (
    <Link to={`surah/${number}`}  className='p-5 rounded-md hover:border-emerald-400 border-2 border-gray-500 flex gap-x-5 items-center bg-gray-500 justify-between cursor-pointer group'>
      ...
      <div className='flex-1 '>
        <h3 className='text-gray-100 font-bold text-base md:text-lg tracking-wide'>{name}</h3>
        <span className='text-gray-300 group-hover:text-emerald-400 text-sm md:text-base'>{translation}</span>
      </div>
      <div>
